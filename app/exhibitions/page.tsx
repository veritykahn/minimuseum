...
export default function Exhibitions() {
  ...
  const exhibitions = [
    ...
    },
    {
      ...
      darkAccent: '#1a0505',
      textColor: '#fff',
      description: 'The Doughboys, the trenches, and the armistice that came at the eleventh hour of the eleventh day.',
      artifacts: ['Trench Periscope', "Soldier's Letter", 'Remembrance Poppy'],
    },
    {
      id: 'holocaust',
      title: 'The Holocaust',
    ...
    },
    {
      ...
      subtitle: 'The Importance of Black Barbie',
      accent: '#EC4899',
      darkAccent: '#2d0a1f',
      textColor: '#fff',
    ...
    },
    {
      ...
      artifacts: ['Urania Typewriter', 'Printing Block', 'Quill Pen'],
    },
    {
      id: 'fear',
      title: 'Fear Lab',
      ...
      artifacts: ['Gothic Novel', 'Memento Mori', 'Ouija Board'],
    },
  ];
  ...
  const Ticket = ({ onClick, accentColor }: { onClick: () => void; accentColor: string }) => (
    ...
    >
      <svg width="180" height="80" viewBox="0 0 180 80" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path 
          d="M0 8C0 3.58172 3.58172 0 8 0H52C52 6.62742 57.3726 12 64 12C70.6274 12 76 6.62742 76 0H172C176.418 0 180 3.58172 180 8V72C180 76.4183 176.418 80 172 80H76C76 73.3726 70.6274 68 64 68C57.3726 68 52 73.3726 52 80H8C3.58172 80 0 76.4183 0 72V8Z" 
          fill="#faf8f5"
        />
        <line x1="64" y1="16" x2="64" y2="64" stroke="#e5e2dc" strokeWidth="1" strokeDasharray="4 3"/>
        <text x="32" y="32" textAnchor="middle" style={{
        ...
        <text x="32" y="44" textAnchor="middle" style={{
          fontFamily: 'Outfit, sans-serif',
          fontSize: '8px',
          fontWeight: 500,
          letterSpacing: '0.15em',
        ...
        <text x="125" y="28" textAnchor="middle" style={{
          fontFamily: 'Cormorant Garamond, serif',
          fontSize: '10px',
          fontWeight: 400,
          fill: '#1a1a1a',
        }}>The Mini Museum</text>
        <text x="125" y="48" textAnchor="middle" style={{
          fontFamily: 'Outfit, sans-serif',
          fontSize: '11px',
          fontWeight: 400,
          letterSpacing: '0.08em',
          fill: accentColor,
        }}>Enter Exhibition</text>
        <line x1="85" y1="58" x2="165" y2="58" stroke={accentColor} strokeWidth="0.5" opacity="0.5"/>
      </svg>
    </button>
  );

  // Exhibition Card in horizontal scroll
      ...
      >
        <div style={{
          ...
          <p style={{
            ...
            marginBottom: '16px',
            fontFamily: 'Outfit, sans-serif',
          }}>Exhibition {String(index + 1).padStart(2, '0')}</p>
  ...
  // Exhibition Room (when you enter)
      ...
      <div className="exhibition-room">
        ...
        <div className="progress-bar">
          <div 
            ...
            style={{ width: `${scrollProgress}%`, background: exhibition.accent }}
          />
        </div>

        {/* Horizontal scroll container */}
        <div ref={roomScrollRef} className="room-scroll" style={{
          background: `linear-gradient(135deg, ${exhibition.darkAccent} 0%, ${exhibition.accent}15 50%, ${exhibition.darkAccent} 100%)`,
        }}>
          {/* Title Section */}
          <section className="room-section" style={{
            background: `radial-gradient(ellipse at center, ${exhibition.accent}40 0%, ${exhibition.darkAccent} 70%)`,
          }}>
            <div style={{
              textAlign: 'center',
          ...
          {exhibition.artifacts.map((artifact: string, i: number) => (
            <section key={i} className="room-section artifact-section" style={{
              background: `radial-gradient(ellipse at ${30 + i * 20}% 50%, ${exhibition.accent}25 0%, ${exhibition.darkAccent} 60%)`,
            }}>
              <div className="glass-case" style={{
                opacity: visibleSections.has(2 + i) ? 1 : 0,
                transform: visibleSections.has(2 + i) ? 'scale(1)' : 'scale(0.9)',
                transition: 'all 0.8s ease-out',
              }}>
                <div className="artifact-placeholder" style={{ borderColor: `${exhibition.accent}50` }}>
                  <span style={{ color: exhibition.accent }}>3D Model</span>
                </div>
          ...
          <section className="room-section" style={{ background: exhibition.darkAccent }}>
            <div style={{
              ...
              <button onClick={onReturn} className="return-button" style={{ borderColor: exhibition.accent, color: exhibition.accent }}>
                Return to Main Hall
              </button>
            </div>
          </section>
        ...
        <div className="room-nav">
          <button onClick={onReturn} className="nav-pill">
            ← Return to Main Hall
          </button>
        </div>
      </div>
    ...
    <div style={{ background: '#0a0a0a', minHeight: '100vh' }}>
      <style jsx global>{`
        ...
        * {
        ...
        /* Horizontal scroll container for main hall */
        .exhibitions-scroll {
          display: flex;
          overflow-x: auto;
          overflow-y: hidden;
        ...
        .exhibitions-scroll::-webkit-scrollbar-thumb {
      ...
      {/* Active Exhibition Room */}
      {activeExhibition && (
        <ExhibitionRoom 
          exhibition={activeExhibition} 
          onReturn={returnToHall}
        />
      )}
    </div>
  );
