    ...
    <div style={{ background: '#0a0a0a', minHeight: '100vh' }}>
      <style jsx global>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .back-link { position: fixed; top: 32px; left: 32px; z-index: 1000; display: flex; align-items: center; gap: 8px; color: #525252; text-decoration: none; font-size: 14px; font-family: 'Cormorant Garamond', Georgia, serif; transition: all 0.3s ease; }
      ...
      <Link href="/greathall" className="back-link"><span className="back-arrow">←</span><span>Great Hall</span></Link>
