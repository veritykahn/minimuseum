        ...
        {currentStep.showIntro && (
          <>
            <p className="intro-text">
              The Mini Museum believes learning doesn&apos;t end at the glass case. These materials are designed to extend the exhibition into your home or classroom&mdash;sparking conversations, deepening understanding, and encouraging the kind of critical thinking that lasts long after the visit.
              <br /><br />
        ...
        {currentStep.showParentDownload && (
          <>
            <p className="description-text">
              Our Parent Resource Guide includes conversation starters, at-home activities, and simple explanations to help you explore the Harlem Renaissance with your child.
            </p>
            <div className="download-section">
              <DownloadItem
                name="Parent Resource Guide"
                subtitle="PDF &bull; Activities &amp; conversation starters"
          ...
          <>
            ...
            <div className="download-section">
              ...
              <DownloadItem
                ...
                subtitle="PDF &bull; Overview &amp; key concepts"
                href="/resources/harlem-renaissance/HR_Teaching_Guide.pdf"
              />
              <DownloadItem
                name="Teacher Explanation Sheet"
                subtitle="PDF &bull; Detailed background info"
                href="/resources/harlem-renaissance/Using Differentiated Student Handouts.pdf"
              />

              <SectionHeader>For Your Classroom</SectionHeader>
              <DownloadItem
                name="Lesson Plan"
                subtitle="PDF &bull; Full lesson with objectives"
