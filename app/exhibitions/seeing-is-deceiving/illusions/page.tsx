...
const illusionContent: IllusionItem[] = [
  ...
  // 4. RUBIN'S VASE (Image-based) - another bistable figure
  {
    type: 'illusion',
  ...
  // 5. FRASER SPIRAL
  {
    ...
    answer: 'CIRCLES! These are perfect concentric circles — no spiral exists. The twisted cord pattern tricks your brain.',
  ...
  // 6. CAFÉ WALL (SVG)
  {
    ...
    answer: 'NEITHER! They\'re perfectly parallel. The offset tiles create a powerful tilt illusion.',
  ...
  // 7. BULGING GRID
  {
    ...
    answer: 'FALSE — It\'s perfectly flat. The varying square sizes create the illusion of depth.',
  ...
  // 11. PONZO RAILROAD (SVG) - simpler version
  {
    ...
    answer: 'FALSE — They\'re identical. The converging lines create false depth, making the "distant" bar seem larger.',
  ...
  // 14. EBBINGHAUS CIRCLES (SVG)
  {
    ...
    question: 'Which orange circle is larger — A or B?',
  ...
  // 17. SANDER PARALLELOGRAM (Image-based)
  {
    type: 'illusion',
  ...
  // 18. POGGENDORFF (Image-based)
  {
    ...
    answer: 'PURPLE — The rectangle disrupts your ability to track the trajectory.',
  ...
  // 19. GRADIENT BAR (Image-based)
  {
    ...
    answer: 'SOLID COLOR! The bar is uniform throughout. The gradient background creates the illusion of variation.',
    ...
    >
      ...
      {currentItem.type === 'illusion' && (
        <>
          ...
          {/* currentIndex 1 = illusion 1, total illusions = length - 2 (minus intro and closing) */}
